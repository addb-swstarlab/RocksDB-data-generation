...
# Internal metrics of RocksDB for analysis
internal_params = [
    'index','rocksdb.block.cache.miss COUNT', 'rocksdb.block.cache.hit COUNT', 'rocksdb.block.cache.add COUNT', 
    'rocksdb.block.cache.add.failures COUNT', 'rocksdb.block.cache.index.miss COUNT', 'rocksdb.block.cache.index.hit COUNT', 
    'rocksdb.block.cache.index.add COUNT', 'rocksdb.block.cache.index.bytes.insert COUNT', 'rocksdb.block.cache.index.bytes.evict COUNT', 
    'rocksdb.block.cache.filter.miss COUNT', 'rocksdb.block.cache.filter.hit COUNT', 'rocksdb.block.cache.filter.add COUNT', 
    'rocksdb.block.cache.filter.bytes.insert COUNT', 'rocksdb.block.cache.filter.bytes.evict COUNT', 'rocksdb.block.cache.data.miss COUNT', 
    'rocksdb.block.cache.data.hit COUNT', 'rocksdb.block.cache.data.add COUNT', 'rocksdb.block.cache.data.bytes.insert COUNT', 
    'rocksdb.block.cache.bytes.read COUNT', 'rocksdb.block.cache.bytes.write COUNT', 'rocksdb.bloom.filter.useful COUNT', 
    'rocksdb.bloom.filter.full.positive COUNT', 'rocksdb.bloom.filter.full.true.positive COUNT', 'rocksdb.bloom.filter.micros COUNT', 
    'rocksdb.persistent.cache.hit COUNT', 'rocksdb.persistent.cache.miss COUNT', 'rocksdb.sim.block.cache.hit COUNT', 
    'rocksdb.sim.block.cache.miss COUNT', 'rocksdb.memtable.hit COUNT', 'rocksdb.memtable.miss COUNT', 'rocksdb.l0.hit COUNT', 
    'rocksdb.l1.hit COUNT', 'rocksdb.l2andup.hit COUNT', 'rocksdb.compaction.key.drop.new COUNT', 'rocksdb.compaction.key.drop.obsolete COUNT', 
...
option = {
    ...
    "compression_type": ["snappy", "zlib", "lz4", "none"], #D:"snappy", B:no "bzip2"
